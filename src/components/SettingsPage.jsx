    ...
    <div style={{maxWidth:860}}>
      ...
      {showJoinSection&&(
        <div className="card" style={{padding:16,border:"1px solid #2A3A50",width:"100%",marginTop:12}}>
          ...
          {!showJoin?(
            <button className="btn btn-secondary btn-md" style={{width:"100%",textAlign:"center",padding:"10px 16px"}} onClick={()=>setShowJoin(true)}>
      ...
      {draftComplete&&hasRecoveryEmail&&(
        <div className="card" style={{padding:16,border:"1px solid #2A3A50",width:"100%",marginTop:12}}>
          ...
          {!showRecovery?(
            <button
              className="btn btn-secondary btn-md"
              style={{width:"100%",textAlign:"center",padding:"10px 16px"}}

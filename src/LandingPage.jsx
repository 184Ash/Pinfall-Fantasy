      ...
      <section className="lp-features">
        ...
        <div className="lp-features-grid lp-reveal">
          {[
            ...
            { icon: "🔄", title: "Live Score Sync", desc: "One button syncs the latest tournament results. Standings update instantly for every team in your league — no manual entry, no spreadsheets." },
